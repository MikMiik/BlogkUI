...
import { useCreateMessageMutation } from "@/features/messageApi";
...
const ChatWindow = ({
  ...
  // Mark conversation as read when chat window is focused
  useEffect(() => {
    if (!isOpen || isMinimized || !conversation?.id) return;
  ...
  }, [isOpen, isMinimized, conversation?.id, markRead]);
      ...
      <div className={styles.chatWindow} {...props}>
        ...
        <div
          className={`${styles.header} ${
            hasNewMessage ? styles.newMessageHeader : ""
          }`}
        >
