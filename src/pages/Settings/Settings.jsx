...
const Settings = () => {
  ...
  const handleSaveSettings = async () => {
    setLoading(true);
    try {
      // Prepare settings data with conditional twoFactorSecret
      const settingsToSave = {
        ...settings,
        twoFactorSecret: settings.twoFactorEnabled
        ...
        <div className={styles.settingRow}>
          ...
          <div className={styles.settingControl}>
            ...
            <Badge variant="success">
              {me.verifiedAt ? "Verified" : "Unverified"}
            </Badge>
          </div>
        </div>
            ...
            <label className={styles.toggle}>
              <input
                ...
                onChange={(e) => {
                  ...
                  handleSettingChange("twoFactorEnabled", isEnabled);
                  // Clear twoFactorSecret when disabling 2FA
                  if (!isEnabled) {
                    handleSettingChange("twoFactorSecret", "");
                  }
                }}
              />
            ...
            <div className={styles.settingControl}>
              <Input
                ...
                onChange={(e) => {
                  ...
                  handleSettingChange("twoFactorSecret", value);
                }}
                placeholder="123456"
                maxLength={6}
      ...
      <div className={styles.settingGroup}>
        ...
        <div className={styles.settingRow}>
          ...
          <label className={styles.toggle}>
            <input
              type="checkbox"
              checked={!!settings.notiNewComments}
              onChange={(e) =>
                handleSettingChange("notiNewComments", e.target.checked)
              }
            />
            <span className={styles.slider}></span>
          </label>
        ...
        <div className={styles.settingRow}>
          ...
          <label className={styles.toggle}>
            <input
              type="checkbox"
              checked={!!settings.notiNewFollowers}
              onChange={(e) =>
                handleSettingChange("notiNewFollowers", e.target.checked)
              }
            />
            <span className={styles.slider}></span>
          </label>
        ...
        <div className={styles.settingRow}>
          ...
          <label className={styles.toggle}>
            <input
              type="checkbox"
              checked={!!settings.notiWeeklyDigest}
              onChange={(e) =>
                handleSettingChange("notiWeeklyDigest", e.target.checked)
              }
            />
            <span className={styles.slider}></span>
          </label>
