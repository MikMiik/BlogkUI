...
const Profile = () => {
  ...
  if (isSuccessProfile) {
    ...
    const canViewProfile = profile.canViewProfile !== false; // Default to true if not specified
    ...
    // Determine display values based on canViewProfile
    const displayName = canViewProfile ? profile.name : "User";
    const displayUsername = canViewProfile ? profile.username : "username";
      ...
      <div className={styles.profile}>
        ...
        <div className={styles.coverSection}>
          <div className={styles.coverImage}>
            <FallbackImage
              src={canViewProfile ? profile.coverImage : null}
              alt="Cover"
            />
            ...
            <div className="container">
              <div className={styles.headerContent}>
                <div className={styles.avatarSection}>
                  <FallbackImage
                    src={canViewProfile ? profile.avatar : null}
                    alt={displayName}
                  ...
                  <div className={styles.basicInfo}>
                    ...
                    {canViewProfile && profile.role && (
                      <p className={styles.title}>{profile.role}</p>
                    )}
                  </div>
                </div>

                {/* Only show action buttons if can view profile */}
                {canViewProfile && (
        ...
        <div className="container">
          {!canViewProfile ? (
            ...
            <div className={styles.restrictedProfile}>
              <div className={styles.restrictedMessage}>
                <div className={styles.restrictedIcon}>🔒</div>
                <h2>User has restricted profile</h2>
                <p>This profile is private and not accessible to you.</p>
              </div>
            </div>
          ) : (
            // Normal profile view
        ...
        {/* Chat Window - Only show if can view profile and not own profile */}
